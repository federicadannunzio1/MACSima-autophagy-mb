...
#SBATCH --output=/lustre/home/gfiscon/projects/MACSima_pipeline/logs/skewness_%j.log
#SBATCH --error=/lustre/home/gfiscon/projects/MACSima_pipeline/logs/skewness_%j.log
...
Rscript "${PROJECT_DIR}/scripts/skewness_analysis.R"
